\chapter{APPENDIX A - MATERIAL DETAILS}\label{apendiceA}	
    ...
    \begin{table}[!htb]
      ...
      \caption{Sources-code, softwares, libraries and its public links on Github.}
    ...
    \begin{table}[H]
      ...
      \begin{tabular}{L{1.3cm}|L{4cm}|C{2.2cm}|C{1.2cm}|C{2.5cm}|C{0.7cm}|C{0.7cm}}
	      ...
	      Superpixel & Segmentation routine with numerous versions of Superpixels, for example, SLIC, SLICO, LSD and SEEDS. The routine was programmed to perform experiments involving classification of façades & Detection & C++ & rodolfolotte/gdal-segment & \faCodeFork & \href{https://github.com/rodolfolotte/gdal-segment}{\faGithub}\\ 	      
	      ...
	      Thesis & \LaTeX version of this thesis & Documentation & \LaTeX\ & rodolfolotte/documentation & - & \href{https://github.com/rodolfolotte/documentation}{\faGithub}\\ \hline
	      \bottomrule	
      \end{tabular}
